    ...
    Animation<Placement> lightRimAnimation{
        {
            ...
            {160, lightRimSwipeStart, HandleType::STOP},
            {161, lightRimSwipeEnd, HandleType::STOP},
            {161, lightRimSwipeStart, HandleType::STOP},
            {162, lightRimSwipeEnd, HandleType::STOP},
            {162, lightRimSwipeStart, HandleType::STOP},
            {163, lightRimSwipeEnd, HandleType::STOP},
            {163, lightRimSwipeStart, HandleType::STOP},
            {164, lightRimSwipeEnd, HandleType::STOP},
            {164, lightRimSwipeStart, HandleType::STOP},
            {165, lightRimSwipeEnd, HandleType::STOP},
            {165, lightRimSwipeStart, HandleType::STOP},
            {166, lightRimSwipeEnd, HandleType::STOP},
            {166, lightRimSwipeStart, HandleType::STOP},
            {167, lightRimSwipeEnd, HandleType::STOP},
            {167, lightRimSwipeStart, HandleType::STOP},
            {168, lightRimSwipeEnd, HandleType::STOP},
            {168, lightRimSwipeStart, HandleType::STOP},
            {169, lightRimSwipeEnd, HandleType::STOP},
            {169, lightRimSwipeStart, HandleType::STOP},
            {170, lightRimSwipeEnd, HandleType::STOP},
            {170, lightRimSwipeStart, HandleType::STOP},
            {171, lightRimSwipeEnd, HandleType::STOP},
            {171, lightRimSwipeStart, HandleType::STOP},
            {172, lightRimSwipeEnd, HandleType::STOP},
            {172, lightRimSwipeStart, HandleType::STOP},
            {173, lightRimSwipeEnd, HandleType::STOP},
            {173, lightRimSwipeStart, HandleType::STOP},
            {174, lightRimSwipeEnd, HandleType::STOP},
            {174, lightRimSwipeStart, HandleType::STOP},
            {175, lightRimSwipeEnd, HandleType::STOP},
            {175, lightRimSwipeStart, HandleType::STOP},
            {176, lightRimSwipeEnd, HandleType::STOP},
            {176, lightRimSwipeStart, HandleType::STOP},

            {192, lightRimSwipeStart, HandleType::STOP},
            {200, {{ 0, 25, 0 }}, HandleType::STOP},
            {344, {{ 0, -3, 0 }}, HandleType::STOP},

            {408, {{ 0, -3, 0 }}, HandleType::STOP},
            {408, lightRimSwipeStart, HandleType::STOP},
            {409, lightRimSwipeEnd, HandleType::STOP},
            {409, lightRimSwipeStart, HandleType::STOP},
            {410, lightRimSwipeEnd, HandleType::STOP},
            {410, lightRimSwipeStart, HandleType::STOP},
            {411, lightRimSwipeEnd, HandleType::STOP},
            {411, lightRimSwipeStart, HandleType::STOP},
            {412, lightRimSwipeEnd, HandleType::STOP},
            {412, lightRimSwipeStart, HandleType::STOP},
            {413, lightRimSwipeEnd, HandleType::STOP},
            {413, lightRimSwipeStart, HandleType::STOP},
            {414, lightRimSwipeEnd, HandleType::STOP},
            {414, lightRimSwipeStart, HandleType::STOP},
            {415, lightRimSwipeEnd, HandleType::STOP},
            {415, lightRimSwipeStart, HandleType::STOP},
            {416, lightRimSwipeEnd, HandleType::STOP},
            {416, lightRimSwipeStart, HandleType::STOP},
            {417, lightRimSwipeEnd, HandleType::STOP},
            {417, lightRimSwipeStart, HandleType::STOP},
            {418, lightRimSwipeEnd, HandleType::STOP},
            {418, lightRimSwipeStart, HandleType::STOP},
            {419, lightRimSwipeEnd, HandleType::STOP},
            {419, lightRimSwipeStart, HandleType::STOP},
            {420, lightRimSwipeEnd, HandleType::STOP},
            {420, lightRimSwipeStart, HandleType::STOP},
            {421, lightRimSwipeEnd, HandleType::STOP},
            {421, lightRimSwipeStart, HandleType::STOP},
            {422, lightRimSwipeEnd, HandleType::STOP},
            {422, lightRimSwipeStart, HandleType::STOP},
            {423, lightRimSwipeEnd, HandleType::STOP},
            {423, lightRimSwipeStart, HandleType::STOP},
            {424, lightRimSwipeEnd, HandleType::STOP},
            {424, lightRimSwipeStart, HandleType::STOP},
        }
    };
    ...
    Animation<glm::vec3> lightRimColorAnimation{
        {
            ...
            {160, {1,1,1}, HandleType::STOP},
            {160, {1,0,0}, HandleType::STOP},
            {168, {0,1,0}, HandleType::STOP},
            {176, {0,0,1}, HandleType::STOP},
            {176, {1,1,1}, HandleType::STOP},

            {200, {1,1,1}, HandleType::STOP},
            {216, {0.45, 0.75, 1}, HandleType::STOP},

            {408, {0.45, 0.75, 1}, HandleType::STOP},
            {408, {1,1,1}, HandleType::STOP},
            {408, {1,0,0}, HandleType::STOP},
            {416, {0,1,0}, HandleType::STOP},
            {424, {0,0,1}, HandleType::STOP},
            {424, {1,1,1}, HandleType::STOP},
    ...
    Animation<float> lightRimBrightnessAnimation{
        {
            ...
            {160, 0, HandleType::STOP},
            {160, 3, HandleType::STOP},
            {161, 0, HandleType::STOP},
            {161, 3, HandleType::STOP},
            {162, 0, HandleType::STOP},
            {162, 3, HandleType::STOP},
            {163, 0, HandleType::STOP},
            {163, 3, HandleType::STOP},
            {164, 0, HandleType::STOP},
            {164, 3, HandleType::STOP},
            {165, 0, HandleType::STOP},
            {165, 3, HandleType::STOP},
            {166, 0, HandleType::STOP},
            {166, 3, HandleType::STOP},
            {167, 0, HandleType::STOP},
            {167, 3, HandleType::STOP},
            {168, 0, HandleType::STOP},
            {168, 3, HandleType::STOP},
            {169, 0, HandleType::STOP},
            {169, 3, HandleType::STOP},
            {170, 0, HandleType::STOP},
            {170, 3, HandleType::STOP},
            {171, 0, HandleType::STOP},
            {171, 3, HandleType::STOP},
            {172, 0, HandleType::STOP},
            {172, 3, HandleType::STOP},
            {173, 0, HandleType::STOP},
            {173, 3, HandleType::STOP},
            {174, 0, HandleType::STOP},
            {174, 3, HandleType::STOP},
            {175, 0, HandleType::STOP},
            {175, 3, HandleType::STOP},
            {176, 0, HandleType::STOP},
            ...
            {408, 0, HandleType::STOP},
            {408, 3, HandleType::STOP},
            {409, 0, HandleType::STOP},
            {409, 3, HandleType::STOP},
            {410, 0, HandleType::STOP},
            {410, 3, HandleType::STOP},
            {411, 0, HandleType::STOP},
            {411, 3, HandleType::STOP},
            {412, 0, HandleType::STOP},
            {412, 3, HandleType::STOP},
            {413, 0, HandleType::STOP},
            {413, 3, HandleType::STOP},
            {414, 0, HandleType::STOP},
            {414, 3, HandleType::STOP},
            {415, 0, HandleType::STOP},
            {415, 3, HandleType::STOP},
            {416, 0, HandleType::STOP},
            {416, 3, HandleType::STOP},
            {417, 0, HandleType::STOP},
            {417, 3, HandleType::STOP},
            {418, 0, HandleType::STOP},
            {418, 3, HandleType::STOP},
            {419, 0, HandleType::STOP},
            {419, 3, HandleType::STOP},
            {420, 0, HandleType::STOP},
            {420, 3, HandleType::STOP},
            {421, 0, HandleType::STOP},
            {421, 3, HandleType::STOP},
            {422, 0, HandleType::STOP},
            {422, 3, HandleType::STOP},
            {423, 0, HandleType::STOP},
            {423, 3, HandleType::STOP},
            {424, 0, HandleType::STOP},
        }
    };
