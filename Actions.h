...
static Action<Placement> DOWN_SWEEP {
    {
        ...
        {1, {{0, 0, 0}, {1, 1, 1}}, HandleType::SMOOTH},
        {2, {{0, -50, 0}, {1, 0, 1}}, HandleType::STOP},
...
static Action<Placement> FORWARD_SWEEP {
    {
        ...
        {1, {{0, 0, 0}, {1, 2, 1}, FORWARD}, HandleType::SMOOTH},
        {2, {{0, 0, 100}, {1, 0, 1}, FORWARD}, HandleType::STOP}
    }, 2, ActionType::STRETCH
};
...
static Action<Placement> SIDEWAYS_SWEEP {
    {
        ...
        {1, {{0, 0, 0}, {1, 2, 1}, SIDEWAYS}, HandleType::SMOOTH},
        {2, {{100, 0, 0}, {1, 0, 1}, SIDEWAYS}, HandleType::STOP}
    }, 2, ActionType::STRETCH
};
